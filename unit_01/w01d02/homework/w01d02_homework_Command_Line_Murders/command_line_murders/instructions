...
To get started on how to use the command line, open cheatsheet.md (from the command line, you can type 'vim cheatsheet.md').

Don't use a text editor to view any files except these instructions, the cheatsheet, and hints.

Once you've found your suspect, make your arrest by creating a file with the 'suspects_name' in the mystery folder. 
Create a new subdirectory called 'jail' in the 'mystery' folder and move the suspect file into the 'jail' directory. 

** Commit your files **

Terminal City is safe again! We will share our answers in class the next day.
